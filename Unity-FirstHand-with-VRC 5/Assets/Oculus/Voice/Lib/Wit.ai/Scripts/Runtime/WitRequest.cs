...
namespace Facebook.WitAi
{
    ...
    public class WitRequest
    {
        ...
        public const string WIT_SDK_VERSION = "0.0.36";
        ...
        private void StartRequest(Uri uri)
        {
            ...
            _request.UserAgent = $"voice-sdk-41.0.0.117.353,wit-unity-{WIT_SDK_VERSION},{operatingSystem},{deviceModel},{configId},{appIdentifier}";
